    ...
    >
      <v-card flat class="rounded-lg">
        <div id="Modal">
          ...
          >
            <defs>
              <linearGradient id="ModalSVGGradient">
        ...
        <v-card dark flat color="transparent" class="px-8 pt-6">
          <v-row no-gutters>
            <v-col cols="10">
              <div class="text-h5 font-weight-thin">Add Section</div>
            </v-col>
        ...
        <div
          ...
          "
        >
          <v-form ref="AddSection" v-model="valid">
            <v-row no-gutters>
              <v-col cols="12" class="px-2">
                <v-text-field
                  ref="SectionCode"
                  v-model.trim="SectionCode"
                  v-mask="'SSS'"
                  ...
                  @keyup.enter="SectionName && AddSection"
                />
              </v-col>
              <v-col cols="12" class="px-2">
                <v-text-field
                  ...
                  @keyup.enter="SectionCode && AddSection"
                />
              </v-col>
  ...
  methods: {
    AddSection() {
      ...
      this.promiseFetch(this.$store.getters.fetchTimeout)(
        fetch(`${this.$store.getters.endpoint}Sections/`, {
          method: "POST",
          headers: {
